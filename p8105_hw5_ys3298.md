...
in a week remains at the same level for control group, wheras increases
...
increases with the increase of size effect.
...
result from beta1$$0, so the model changes here.
