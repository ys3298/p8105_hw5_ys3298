...
From the plots, we can see the overall observations in experimental group are higher than the control group and the observation for each day in a week flactuate a lot but basiclly remains at the same level for control group, wheras increases for observation group.
...
Because the null here is beta1 = 0. When we reject the null, we get result from beta1 not equal to 0. As the real beta 1 increases, the difference between these two will converge.
